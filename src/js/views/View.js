...
export default class View {
   ...
   * @param {boolea} [render = true] If false,create markup string instead of rendering of the DOM
   * @returns {undefined | string} A markup string is retuned if render = false
   * @this {Object} View istance
   * @author Jonas Schmedtann
  ...
  renderSuccesMesage(message = this._succesMessage) {
    console.log(1);
    this._clear();
    const markup = `
        <div class="message">
